...
import './DrawerList.css'; // Import the CSS file for styling
                    ...
                    <div className="space-y-2">
                        {menu.map((item) => (
                            <div key={item.name} onClick={handleClick(item)} className="pr-9 cursor-pointer">
                                <p className={`nav-link ${item.path === location.pathname ? "active" : ""} flex items-center px-5 py-3 rounded-r-full`}>
