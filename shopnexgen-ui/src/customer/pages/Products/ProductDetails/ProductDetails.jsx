                ...
                <section>
                    ...
                    <div className='space-y-2'>
                        <div className='price flex items-center gap-3 mt-5 text-lg'>
                            ...
                            <span className='text-[#3f51b5] font-semibold'>{products.product?.discountPercent}% off</span>
                        </div>
                    ...
                    <div className="mt-12 flex items-center gap-5">
                        ...
                        <Button
                            ...
                            startIcon={wishlist.wishlist && isWishlisted(wishlist.wishlist, products.product) ? 
                                <FavoriteIcon sx={{ color: teal[500] }} /> : 
                                <FavoriteBorderIcon />
                            }
                        >
                            {wishlist.wishlist && isWishlisted(wishlist.wishlist, products.product) ? 
